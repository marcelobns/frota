<div class="motoristas index">
	...
	<tr>
		...
		<td><?php echo h($motorista['Motorista']['ativo']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $motorista['Motorista']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $motorista['Motorista']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $motorista['Motorista']['id']), array(), __('Are you sure you want to delete # %s?', $motorista['Motorista']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
