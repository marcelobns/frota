...
<?php echo $this->Form->create('Abastecimento'); ?>
	<fieldset>
		<legend><?php echo __('Edit Abastecimento'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Abastecimento.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Abastecimento.id'))); ?></li>
